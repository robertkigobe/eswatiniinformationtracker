...
<body>
	...
	<div id="container">
		...
		<div id="content">
			...
			<form:form action="searchMeAttendanceVerifyAll" method="GET" class="form">
				...
				<div class="row">
					...
					<div class="col">
						...
						<button class="btn btn-outline-success my-2 my-sm-0 form-control"
							type="submit">Verify All</button>
					</div>

					<div class="col">
						<a
							href="${pageContext.request.contextPath}/attendanceMe/list_attendance_me"
			...
			<table class="table">
				...
				<c:forEach var="tempAttendance" items="${attendance}">
					...
					<c:url var="packLink" value="/attendanceMe/showFormForPackAttendance">
					...
					<tr>
						...
						<td>
							<!-- display the disqualify link --> <a href="${packLink}">Pack Entry</a> 
